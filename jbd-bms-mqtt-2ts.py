...
class MyDelegate(DefaultDelegate):  # When the device replies this code is invoked to deal with it
    ...
    def handleNotification(self, cHandle, data):
        ...
        print("this is the hex_data- ", hex_data)
...
bleAddrP = "8e:c2:30:38:c1:a4"  # BLE address that will be used rather than a BLE name
...
broker = "192.168.1.86"  # Change this to your MQTT broker address
